    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsMainCart = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "AmountInWarehouse", "Description", "Name", "Price", "Ratting" },
                values: new object[,]
                {
                    { 1, 100, "A car", "Car", 0, (byte)6 },
                    { 2, 56, "A carrot", "Carrot", 0, (byte)3 },
                    { 3, 47, "A plant", "Plant", 0, (byte)6 },
                    { 4, 5, "Boots", "Boots", 0, (byte)6 },
                    { 5, 13, "A shovel", "Shovel", 0, (byte)6 },
                    { 6, 17, "A chainsaw", "Chainsaw", 0, (byte)6 },
                    { 7, 26, "A black bag", "Black bag", 0, (byte)6 },
                    { 8, 59, "A bleach", "Bleach", 0, (byte)6 },
                    { 9, 1234, "A poster", "Poster", 0, (byte)6 }
                });
